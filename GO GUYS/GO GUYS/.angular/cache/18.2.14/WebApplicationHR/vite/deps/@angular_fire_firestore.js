...
var __PRIVATE_TargetState = class {
  constructor() {
    ...
    this.we = ByteString2.EMPTY_BYTE_STRING, this.Se = false, /**
...
var __PRIVATE_RestConnection = class {
  ...
  So(e, t, n, r, i) {
    ...
    return this.Do(_, r, i), this.vo(e, o, _, n).then((t2) => (__PRIVATE_logDebug(Ut, `Received RPC '${e}' ${s}: `, t2), t2), (t2) => {
      throw __PRIVATE_logWarn2(Ut, `RPC '${e}' ${s} failed with error: `, t2, "url: ", o, "request:", n), t2;
    });
  }
  Co(e, t, n, r, i, s) {
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
  ...
  Wo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logWarn2(Wt, `RPC '${e}' stream ${r} transport errored:`, t2), P.Uo(new FirestoreError2(C.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P.Uo(new FirestoreError2(n3, i3)), c.close();
      ...
      */
      (yield function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        n2.targetMismatches.forEach((t4, n3) => {
          ...
          if (!r)
            return;
          e2.K_.set(t4, r.withResumeToken(ByteString2.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion2(S, b, e), // BUILD_TARGET will be replaced by values like esm2017, cjs2017, etc during the compilation
  registerVersion2(S, b, "esm2017");
}();
